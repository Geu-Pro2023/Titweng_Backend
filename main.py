...
# ---------------------------
# Public Cow Face Lookup
# ---------------------------
@app.get("/cow/{cow_tag}/face", summary="Get cow facial image by tag")
def get_cow_face_by_tag(
    cow_tag: str,
    db: Session = Depends(get_db)
):
    """Public endpoint to get cow facial image and basic details by tag"""
